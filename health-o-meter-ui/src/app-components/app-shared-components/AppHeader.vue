      ...
      <div class="container">
        ...
        <div class="az-header-right">
          ...
          <div class="dropdown az-header-notification" v-on:click="notificationOn" >
            ...
            <div class="dropdown-menu" v-bind:class="{ show: this.isNotificationActive }"  >
              ...
              <div class="az-notification-list">
                ...
                <div class="media new">
                  <div class="az-img-user online"><img src="../../assets/img/faces/face3.jpg" alt=""></div>
                  <div class="media-body">
          ...
          <div class="dropdown az-profile-menu" v-on:click="profileOn" >
            ...
            <div class="dropdown-menu" v-bind:class="{ show: this.isProfileActive }" >
