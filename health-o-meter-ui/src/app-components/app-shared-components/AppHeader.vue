  ...
  <div class="az-header">
    <div class="container">
      <div class="az-header-left">
        <router-link to="/patient-health-dashboard"
          ><a class="az-logo"
            ><span style="color : #5b47fb">Health "O" Meter</span></a
          ></router-link
        >
      ...
      <div class="az-header-right">
        <a
          href="https://www.bootstrapdash.com/demo/azia-free/docs/documentation.html"
          target="_blank"
          class="az-header-search-link"
          ><i class="far fa-file-alt"></i
        ></a>
        <a href="" class="az-header-search-link"
        ...
        <div
          class="dropdown az-header-notification"
          v-on:click="notificationOn"
        >
          <a class="new"><i class="typcn typcn-bell"></i></a>
          <div
            class="dropdown-menu"
            v-bind:class="{ show: this.isNotificationActive }"
          >
            ...
            <div class="az-notification-list">
              ...
              <div class="media new">
                <div class="az-img-user online">
                  <img src="../../assets/img/faces/face3.jpg" alt="" />
                </div>
                <div class="media-body">
                  <p>
              ...
              <div class="media">
                <div class="az-img-user">
                  <img src="../../assets/img/faces/face4.jpg" alt="" />
                </div>
                <div class="media-body">
                  <p>
        ...
        <div class="dropdown az-profile-menu" v-on:click="profileOn">
          ...
          <div
            class="dropdown-menu"
            v-bind:class="{ show: this.isProfileActive }"
          >
...
<script>
import Repository from "@/app-helper-services/PatientRepositoryFactory.js";
const PatientInfoRepository = Repository.get("patient");
export default {
  name: 'AppHeader',
  ...
  created() {
    this.getpatientbyId('609e811876c2dd1183be7290');
  },
  methods: {
    notificationOn() {
