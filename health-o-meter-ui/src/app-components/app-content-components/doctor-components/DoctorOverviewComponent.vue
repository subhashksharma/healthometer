<template>
  <div class="az-profile-body">
    ...
    <div class="row mg-b-20">
      ...
      <div class="col-md-5 col-xl-4 mg-t-40 mg-md-t-0">
        ...
        <div class="az-traffic-detail-item">
          ...
          <div class="progress">
            <div
              class="progress-bar bg-success wd-15p"
              role="progressbar"
              aria-valuenow="15"
              aria-valuemin="0"
              aria-valuemax="100"
        ...
        <div class="az-traffic-detail-item">
          ...
          <div class="progress">
            <div
              class="progress-bar bg-pink wd-45p"
              role="progressbar"
              aria-valuenow="45"
              aria-valuemin="0"
              aria-valuemax="100"
        ...
        <div class="az-traffic-detail-item">
          ...
          <div class="progress">
            <div
              class="progress-bar bg-teal wd-25p"
              role="progressbar"
              aria-valuenow="25"
              aria-valuemin="0"
              aria-valuemax="100"
    ...
    <div class="row">
      ...
      <!-- col -->
      <div class="col-md-5 col-xl-4 mg-t-40 mg-md-t-0">
        <div class="az-content-label tx-12 mg-b-25">
